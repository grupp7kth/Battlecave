...
extern int botScanLine(int length, int angle, int stepSize, int *id);
extern void goDefensive(int *id, float *netSpeed, float scanDegrees);
extern void goAggressive(int *id, int *closestDistance, int *closestType, int *closestAngle, float *netSpeed, int *deltaX, int *deltaY);
extern void handleBotShooting(int *id, int *closestDistance, int *closestType, int *closestAngle);
extern float getNetSpeed(float xVel, float yVel);
extern int getDelta(int p1, int p2);
extern int getObjectDistance(int deltaX, int deltaY);
extern int getObjectAngle(int deltaX, int deltaY);
